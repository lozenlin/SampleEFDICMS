...
public partial class Article_Picture : System.Web.UI.Page
{
    ...
    {
        c = new ArticlePictureCommonOfBackend(this.Context, this.ViewState, new Common.DataAccess.EF.EmployeeAuthorityDataAccess(), new Common.DataAccess.EF.ArticlePublisherDataAccess());
