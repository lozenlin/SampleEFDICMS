...
public partial class Article_Video : System.Web.UI.Page
{
    ...
    {
        c = new ArticleVideoCommonOfBackend(this.Context, this.ViewState, new Common.DataAccess.EF.EmployeeAuthorityDataAccess(), new Common.DataAccess.EF.ArticlePublisherDataAccess());
